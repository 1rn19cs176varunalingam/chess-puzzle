...
void medium_puzzle1()
{
   ...
   checks1:
    ...
    scanf("%s",in);
     if(strcmp(in,"Qxf7")==0 || strcmp(in,"QXF7")==0|| strcmp(in,"QxF7")==0 || strcmp(in,"QXf7")==0 || strcmp(in,"qXf7")==0|| strcmp(in,"qxf7")==0 || strcmp(in,"Qxf7")==0 )
    {
        system("cls");
        p2[0].a[1][5]=81;
        p2[0].a[1][2]=0;
        ...
        scanf("%s",in);
         if(strcmp(in,"Kxe6")==0 || strcmp(in,"KXe6")==0|| strcmp(in,"KxE6")==0 || strcmp(in,"KXe6")==0 || strcmp(in,"KXe6")==0|| strcmp(in,"kxe6")==0 || strcmp(in,"kxe6")==0 )
    {
        system("cls");
        p2[0].a[2][4]=75;
        p2[0].a[3][6]=0;
        ...
        printf("\n\n\n\n\t\t\t\t\t\t  Your turn! Awaiting your move ");
        scanf("%s",in);
        if(strcmp(in,"Qc7")==0 || strcmp(in,"QC7")==0|| strcmp(in,"QC7")==0 || strcmp(in,"Qc7")==0 || strcmp(in,"qc7")==0|| strcmp(in,"qc7")==0 || strcmp(in,"Qc7")==0 )
            {
                system("cls");
   ...
   checkss1:
    ...
    printf("\n\n\n\n\t\t\t\t\t\t  You play as White! Awaiting your move ");
    scanf("%s",in);
    if(strcmp(in,"bH7")==0 || strcmp(in,"Bh7")==0|| strcmp(in,"BH7")==0|| strcmp(in,"bh7")==0  )
    {
        system("cls");
        p2[1].a[2][6]=0;
        p2[1].a[1][7]=66;
        ...
        printf("\n\n\n\n\t\t\t\t\t\t  Your turn! Awaiting your move ");
        scanf("%s",in);
         if(strcmp(in,"QF5")==0 || strcmp(in,"Qf5")==0|| strcmp(in,"qF5")==0 || strcmp(in,"qf5")==0 )
    {
        system("cls");
        p2[1].a[2][5]=0;
        p2[1].a[3][5]=81;
        ...
        printf("\n\n\n\n\t\t\t\t\t\t  Your turn! Awaiting your move ");
        scanf("%s",in);
         if(strcmp(in,"xh6")==0 || strcmp(in,"xH6")==0|| strcmp(in,"Xh6")==0 || strcmp(in,"XH6")==0)
            {
                system("cls");
